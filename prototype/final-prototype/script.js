...
function renderHome() {
  return `
    ...
    <p style="margin-top: 36px; font-size: .85rem; color: var(--ink-500);">
...
function renderAdminLogin() {
  return `
    <form id="loginForm" class="glass form-card login-card" novalidate>
      ...
      <div class="hint" id="loginError" role="alert" style="color: var(--danger-fg); display:none;">Incorrect email or password.</div>
...
function renderAdminEdit(id) {
  ...
  return `
    ...
    <form id="editForm" class="glass form-card">
      ...
      <div class="form-group" id="newRoomGroup" style="display: ${cls.status === "Room Changed" ? "block" : "none"};">
...
function bindAdminEditEvents(id) {
  ...
  form.querySelectorAll('input[name="status"]').forEach(radio => {
    radio.addEventListener("change", () => {
      ...
      newRoomGroup.style.display = showRoom ? "block" : "none";
